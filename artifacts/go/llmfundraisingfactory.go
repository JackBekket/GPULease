...
func (_LLMFundraisingFactory *LLMFundraisingFactoryCaller) FeeRecipient(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _LLMFundraisingFactory.contract.Call(opts, &out, "feeRecipient")
...
//
// Solidity: function feeRecipient() view returns(address)
func (_LLMFundraisingFactory *LLMFundraisingFactorySession) FeeRecipient() (common.Address, error) {
	return _LLMFundraisingFactory.Contract.FeeRecipient(&_LLMFundraisingFactory.CallOpts)
}

// FeeRecipient is a free data retrieval call binding the contract method 0x46904840.
//
// Solidity: function feeRecipient() view returns(address)
func (_LLMFundraisingFactory *LLMFundraisingFactoryCallerSession) FeeRecipient() (common.Address, error) {
	return _LLMFundraisingFactory.Contract.FeeRecipient(&_LLMFundraisingFactory.CallOpts)
}
